 ...
 */
public class ActividadGrandes extends javax.swing.JFrame {
        ...
        switch (evt.getKeyChar()) {
            ...
            case KeyEvent.VK_SPACE:
                ...
                if(contador == 0) {
                    ...
                    control.iniciarActividadGrandes();
                    contador++;
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActividadGrandes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ActividadGrandes().setVisible(true);
            }
        });
    }
