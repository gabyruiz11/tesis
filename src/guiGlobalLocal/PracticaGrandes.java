 ...
 */
public class PracticaGrandes extends javax.swing.JFrame {
    ...
    private void panelPrincipalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_panelPrincipalKeyPressed
        ...
        switch (evt.getKeyChar()) {
            ...
            case KeyEvent.VK_SPACE:
                ...
                control.iniciarPracticasGrandes();
                break;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PracticaGrandes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PracticaGrandes().setVisible(true);
            }
        });
    }
